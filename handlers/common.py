...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = f"""✨ Привет, {user_name}! Я — твой персональный AI-помощник по здоровью.

🤖 <b>Что я умею:</b>
• 🍽️ **Записывать приём пищи** — просто опиши, что съел, или отправь фото
• 💧 **Отслеживать воду** — напиши, сколько выпил
• 🏃 **Учитывать активность и шаги** — «пробежал 5 км» или «10000 шагов»
• ⚖️ **Анализировать вес и прогресс** — покажу графики и дам прогноз
• 🧬 **Рассчитывать композицию тела** — ИМТ, % жира, мышечную массу и нормы
• 🤖 **Отвечать на любые вопросы** о питании, тренировках и здоровье

💬 <b>Как общаться?</b>
Просто пиши мне всё, что считаешь нужным, на естественном языке.
Я сам пойму, что тебе нужно: записать еду, показать прогресс или дать совет.
...
**Выбери действие в меню ниже или просто задай вопрос.**"""
