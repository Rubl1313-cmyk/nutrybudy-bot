...
@router.message(~F.command & ~F.text.contains("🍽️") & ~F.text.contains("💧") & ~F.text.contains("🏃‍♂️") & ~F.text.contains("⚖️") & ~F.text.contains("📊") & ~F.text.contains("🍽️") & ~F.text.contains("🏆") & ~F.text.contains("🤖") & ~F.text.contains("👤") & ~F.text.contains("⚙️") & ~F.text.contains("❓") & ~F.text.contains("🏠") & ~F.text.contains("🚶") & ~F.text.contains("🚶‍♀️") & ~F.text.contains("🏃") & ~F.text.contains("🏃‍♂️") & ~F.text.contains("✏️") & ~F.text.contains("📈") & ~F.text.contains("🧠"))
