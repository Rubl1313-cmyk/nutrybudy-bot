...
def metabolic_age(bmr: float, chronological_age: int, gender: str, weight_kg: float, height_cm: float) -> int:
    ...
    # Средние значения BMR по возрасту и полу
    avg_bmr = {
        'male': {
            18: 1650, 25: 1700, 30: 1750, 35: 1750, 40: 1750, 45: 1700, 50: 1650, 55: 1600, 60: 1550, 65: 1500
        },
        'female': {
            18: 1350, 25: 1350, 30: 1350, 35: 1350, 40: 1350, 45: 1350, 50: 1300, 55: 1250, 60: 1200, 65: 1150
        }
    }
