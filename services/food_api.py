...
# ========== ГРУППЫ ПРОДУКТОВ ДЛЯ ВЫБОРА ВАРИАНТА ПРИГОТОВЛЕНИЯ ==========
# Ключ — базовое название (то, что может ввести пользователь или определить AI).
# Значение — список ключей из LOCAL_FOOD_DB, которые соответствуют разным вариантам.
PRODUCT_VARIANT_GROUPS = {
    # --- МЯСО, ПТИЦА, СУБПРОДУКТЫ (общие группы) ---
    "мясо": [
        # Говядина
        ...
        # Другое
        "индейка", "индюшиная грудка", "баранина", "кролик", "утка", "телятина"
    ],
    "говядина": [
        "говядина", "говяжий фарш", "говяжья печень", "язык говяжий"
    ],
    ...
    "рыба": [
        ...
        "тунец консервированный", "шпроты"
    ],
    "лосось": ["лосось", "семга"],
    "треска": ["треска", "минтай", "хек"],
    "скумбрия": ["скумбрия", "сельдь"],
    "морепродукты": [
        "креветки", "кальмар", "мидии", "устрицы", "краб", "крабовые палочки", "осьминог",
        "гребешки", "икра красная", "икра чёрная"
    ],
    "креветки": ["креветки"],
    "краб": ["краб", "крабовые палочки"],

    # --- МОЛОЧНЫЕ ПРОДУКТЫ И ЯЙЦА ---
    "молоко": ["молоко", "кефир", "йогурт", "ряженка", "простокваша", "айран", "кумыс"],
    "кефир": ["кефир"],
    "йогурт": ["йогурт", "йогурт греческий"],
    "творог": ["творог", "творог обезжиренный", "творожная масса"],
    "сыр": [
        "сыр", "сыр твёрдый", "пармезан", "моцарелла", "фета", "брынза", "сулугуни",
        "сыр плавленый", "рикотта", "маскарпоне", "чеддер", "гауда", "камамбер", "бри"
    ],
    "масло сливочное": ["масло сливочное"],
    "сливки": ["сливки", "сметана"],
    "яйцо": ["яйцо", "яичный белок", "яичный желток"],
    ...
    "лук": ["лук", "лук зеленый", "лук-порей", "лук-шалот"],
    "капуста": [
        "капуста", "капуста краснокочанная", "капуста савойская", "капуста пекинская",
        "брокколи", "цветная капуста", "кольраби", "брюссельская капуста"
    ],
    ...
    "яблоко": ["яблоко"],
    "цитрусовые": ["апельсин", "мандарин", "лимон", "лайм", "грейпфрут"],
    "ягоды": [
        "клубника", "малина", "ежевика", "голубика", "клюква", "смородина красная",
        "смородина чёрная", "крыжовник", "вишня", "черешня"
    ],
    "клубника": ["клубника"],
    "малина": ["малина", "ежевика", "голубика"],
    "сухофрукты": ["изюм", "курага", "чернослив", "финики", "инжир"],

    # --- КРУПЫ, МАКАРОНЫ, БОБОВЫЕ ---
    "крупы": [
        "гречка", "рис", "рис бурый", "овсянка", "манка", "пшено", "перловка",
        "булгур", "кускус", "киноа", "полента", "овсяные хлопья"
    ],
    "гречка": ["гречка"],
    "рис": ["рис", "рис бурый"],
    "овсянка": ["овсянка", "овсяные хлопья", "мюсли", "гранола"],
    "макароны": [
        "макароны", "спагетти", "лапша", "вермишель", "пенне", "фузилли",
        "ракушки", "бантики", "лазанья"
    ],
    "спагетти": ["спагетти"],
    "бобовые": [
        "фасоль", "чечевица", "нут", "горох", "маш", "соя", "тофу",
        "стручковая фасоль", "горошек", "кукуруза"
    ],
    ...
    # --- ХЛЕБ И ВЫПЕЧКА ---
    "хлеб": ["хлеб", "хлеб ржаной", "батон", "лаваш", "булочка", "багет", "пита", "лепёшка"],
    "булочка": ["булочка", "булочка для бургера", "круассан"],
    "лаваш": ["лаваш", "пита"],
    "выпечка": [
        "печенье", "пряники", "крекер", "вафли", "кекс", "бисквит", "пирожное",
        "пирог", "торт", "пончик", "сдоба", "сухарики", "гренки"
    ],

    # --- ОРЕХИ И СЕМЕНА ---
    "орехи": [
        "грецкий орех", "миндаль", "фундук", "арахис", "кешью", "пекан",
        "фисташки", "кедровые орехи", "кокос", "кокосовая стружка"
    ],
    ...
    "масла": ["оливковое масло", "подсолнечное масло", "льняное масло", "кунжутное масло"],
    "специи": [
    ...
    "напитки": [
        ...
        "компот", "морс", "кисель", "лимонад"
    ],
    "сок": ["сок апельсиновый", "сок яблочный", "сок томатный"],
    "кофе": ["кофе", "кофе с молоком", "латте", "капучино"],
    "чай": ["чай", "чай зеленый", "чай черный", "травяной чай"],
    "алкоголь": ["пиво светлое", "вино красное сухое", "вино белое сухое", "шампанское", "коньяк", "водка"],
    ...
    "консервы": [
        ...
        "персик консервированный", "оливки", "маслины", "корнишоны"
    ],

    # --- ЗЕЛЕНЬ И САЛАТ ---
    "зелень": [
        "укроп", "петрушка", "кинза", "базилик", "мята", "руккола", "шпинат",
        "щавель", "портулак", "мангольд", "крапива", "черемша"
    ],
    "салат": [
        "салат", "салат айсберг", "салат романо", "салат фризе", "салат корн",
        "салат латук", "эскариоль", "радиккьо", "кресс-салат"
    ],
}
