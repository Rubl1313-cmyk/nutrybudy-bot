...
Добавлено распознавание расстояния в километрах.
"""
import re
...
INTENT_KEYWORDS = {
    "water": [r'\bвода\b', r'\bводы\b', r'\bвыпил\b', r'\bпопил\b', r'\bпить\b', r'\bхочу пить\b', r'\bвыпей\b', r'\bнапился\b'],
    "shopping": [r'\bкупить\b', r'\bсписок покупок\b', r'\bдобавь в список\b', r'\bнадо купить\b', r'\bзапиши в покупки\b', r'\bдобавь в покупки\b', r'\bкуплю\b'],
    "activity": [r'\bтренировка\b', r'\bспорт\b', r'\bзанятие\b', r'\bпробежка\b', r'\bактивность\b', r'\bупражнения\b'],
    "reminder": [r'\bнапомни\b', r'\bнапоминание\b', r'\bне забудь\b', r'\bнапомни мне\b'],
    "food": [r'\bзапиши еду\b', r'\bдобавь еду\b', r'\bсъел\b', r'\bпоел\b', r'\bприем пищи\b', r'\bеда\b', r'\bпокушать\b', r'\bпокушал\b', r'\bпоесть\b', r'\bплотно поел\b'],
    "weather": [r'\bпогода\b', r'\bсколько градусов\b', r'\bтемпература\b', r'\bпрогноз погоды\b', r'\bкакая погода\b', r'\bна улице\b', r'\bтепло\b', r'\bхолодно\b'],
    "ai": [r'\bai\b', r'\bаи\b', r'\bспроси\b', r'\bвопрос\b', r'\bскажи\b', r'\bпомоги\b', r'\bрецепт\b', r'\bчто такое\b', r'\bкак сделать\b', r'\bпочему\b', r'\bзачем\b', r'\bкогда\b', r'\bгде\b', r'\bкто\b', r'\bнапиши\b', r'\bсоставь\b', r'\bпридумай\b', r'\bрасскажи\b', r'\bобъясни\b', r'\bпосоветуй\b']
}
