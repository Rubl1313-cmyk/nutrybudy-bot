...
INTENT_KEYWORDS = {
    ...
    "food": [
        ...
        # Общие слова для еды
        r'\bкалории\b', r'\bкалорийность\b', r'\bбелки\b', r'\bжиры\b', r'\bуглеводы\b',
        r'\bзавтрак\b', r'\bобед\b', r'\bужин\b', r'\bперекус\b', r'\bполдник\b',
        r'\bсъесть\b', r'\bпоесть\b', r'\bкушать\b', r'\bхочу есть\b', r'\bпроголодался\b', r'\bпроголодалась\b'
    ],
    "weather": [
